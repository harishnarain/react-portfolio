  ...
  const projects = [
    {
      ...
      description:
        "Geoverse is a modern take on the '90s Geocities. We bring globally diverse communities together",
    ...
    },
    {
      ...
      description:
        "SaaS admin site with ReactJS, Azure AD, and Azure Functions",
    ...
    },
    {
      ...
      description:
        "API to manage customer records. Uses Azure Functions, MongoDB and JavaScript",
    ...
    <Aux>
      ...
      <Grid container spacing={3} className={classes.container}>
        ...
        <Grid container spacing={3}>
          ...
          >
            Here is some my recent class projects, single page apps and
            serverless APIs
          </Typography>
        </Grid>
        <Grid container spacing={3}>
